...
<div class="row-fluid">
<div class="span12">
<form action="index.php?option=com_helpdeskpro&view=priorities" method="post" name="adminForm" id="adminForm">
<table width="100%">
<tr>
	<td align="left">
...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th width="10%" nowrap="nowrap">
				...
				<?php echo JHTML::_('grid.order',  $this->items , 'filesave.png', 'priority.save_order' ); ?>
			</th>			
			<th width="5%">
	...
	{
		$row = &$this->items[$i];
		$link 	= JRoute::_( 'index.php?option=com_helpdeskpro&task=priority.edit&cid[]='. $row->id);
		$checked 	= JHTML::_('grid.id',   $i, $row->id );				
		$published 	= JHTML::_('grid.published', $row, $i, 'tick.png', 'publish_x.png', 'priority.' );				
		?>
		<tr class="<?php echo "row$k"; ?>">
			...
			<td class="order">
				<span><?php echo $this->pagination->orderUpIcon( $i, true, 'priority.orderup', 'Move Up', $ordering ); ?></span>
				<span><?php echo $this->pagination->orderDownIcon( $i, $n, true, 'priority.orderdown', 'Move Down', $ordering ); ?></span>
