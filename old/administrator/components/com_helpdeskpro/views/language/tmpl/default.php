...
<form action="index.php?option=com_helpdeskpro&view=language" method="post" name="adminForm" id="adminForm">
	<table style="width:100%;">
		<tr>			
			<td style="text-align: left;">
				<?php echo JText::_( 'Filter' ); ?>:
				<input type="text" name="search" id="search" value="<?php echo $this->lists['search'];?>" class="text_area search-query input-medium" onchange="document.adminForm.submit();" />		
