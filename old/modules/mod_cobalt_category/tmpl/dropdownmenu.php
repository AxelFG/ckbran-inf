	...
	<ul class="nav nav-list">
	    <li class="dropdown">
	    	<?php if( $params->get( 'show_section', 1 ) ) : ?>
	    		<a class="" href="index.php" style="display: inline">
	    			<?php echo $section->name;?>
	    			</a><b class="caret dropdown-toggle" data-toggle="dropdown" ></b>
	    	<?php else :?>
		    <a class="dropdown-toggle" data-toggle="dropdown" href="#"><?php echo JText::_('CCATEGORIESLIST')?><b class="caret"></b></a>
		    <?php endif;?>
		    <ul class="dropdown-menu">
			<?php foreach ($categories as $cat) :
				if (!$params->get('tmpl_params.cat_empty', 1) && !$cat->num_current && !$cat->num_all) continue;  ?>
				<li class="dropdown<?php if($cat->childs_num) echo '-submenu';?>" >
