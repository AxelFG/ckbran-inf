...
Objarticlerelated = new Class({
	...
	initialize: function(id, options) {
		...
		this._bar = $(this.id); 
                ...
                $$("#fieldsattach-slider-articlerelated .updatebutton").setStyle("display","none");
        ...
        revalue: function(){
            ...
            size = el.getElement("input#jform_params_field_articlerelated_size").get("value"); 
        ...
        { 
            $('jform_params_field_articlerelated_size').set("value", size); 
        },
        eventinput:function(obj){
            ...
            event.stop(); //Prevents the browser from following the articlerelated.
            
            $("wrapperextrafield_articlerelated").ObjInput.revalue();
            });
