...
Objpricerelated = new Class({
	...
	initialize: function(id, options) {
		...
		this._bar = $(this.id); 
                ...
                $$("#fieldsattach-slider-pricerelated .updatebutton").setStyle("display","none");
        ...
        revalue: function(){
            ...
            size = el.getElement("input#jform_params_field_pricerelated_size").get("value"); 
        ...
        { 
            $('jform_params_field_pricerelated_size').set("value", size); 
        },
        eventinput:function(obj){
            ...
            event.stop(); //Prevents the browser from following the pricerelated.
            
            $("wrapperextrafield_pricerelated").ObjInput.revalue();
            });
