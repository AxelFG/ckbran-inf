...
Objcontactrelated = new Class({
	...
	initialize: function(id, options) {
		...
		this._bar = $(this.id); 
                ...
                $$("#fieldsattach-slider-contactrelated .updatebutton").setStyle("display","none");
        ...
        revalue: function(){
            ...
            size = el.getElement("input#jform_params_field_contactrelated_size").get("value"); 
        ...
        { 
            $('jform_params_field_contactrelated_size').set("value", size); 
        },
        eventinput:function(obj){
            ...
            event.stop(); //Prevents the browser from following the contactrelated.
            
            $("wrapperextrafield_contactrelated").ObjInput.revalue();
            });
