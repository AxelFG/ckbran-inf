 ...
 * @contactrelated		http://joomlacode.org/gf/project/fieldsattach_1_6/
...
class plgfieldsattachment_contactrelated extends JPlugin

{
	 ...
	 */
        ...
        function plgfieldsattachment_contactrelated(& $subject, $config)
...

	{
            ...
            $lang->load( 'plg_fieldsattachment_contactrelated' );
        ...
        { 
            ...
            $form = $this->form->getFieldset("percha_contactrelated");

            $return .= JHtml::_('sliders.panel', JText::_( "JGLOBAL_FIELDSET_contactrelated_OPTIONS"), "percha_".$this->params->get( 'name', "" ).'-params');
           ...
           // foreach ($this->param as $name => $fieldset){
            ...
            $return .=  '<div><input type="button" value="'.JText::_("Update Config").'" onclick="controler_percha_contactrelated()" /></div>';

            }

            $return .=  ' </fieldset>';

            //$return .=  '<script src="'. JURI::base().'../plugins/fieldsattachment/contactrelated/controler.js" type="text/javascript"></script> ';
        ...
        {  
            ...
            if(file_exists($css)){ $str .=  '<contactrelated rel="stylesheet" href="'.$pathcss.'" type="text/css" />'; } 
...

        {
             ...
             $return ='<option value="contactrelated" ';

             if("contactrelated" == $valor)   $return .= 'selected="selected"';
	 ...
	 */
...

        {
             ...
             //Search field template GENERIC *****************************************************************
              ...
              $templateDir =  dirname(__FILE__).'/tmpl/contactrelated.tpl.php'; 
              ...
              $templateDir =  JPATH_BASE . '/templates/' . $app->getTemplate().'/html/com_fieldsattach/fields/contactrelated.tpl.php';
              ...
              $templateDir =  JPATH_BASE . '/templates/' . $app->getTemplate().'/html/com_fieldsattach/fields/'.$fieldsids.'_contactrelated.tpl.php';
	 ...
	 */
...

        {
             ...
             //Search field template GENERIC *****************************************************************
              ...
              $templateDir =  dirname(__FILE__).'/tmpl/contactrelated_line.tpl.php'; 
              ...
              $templateDir =  JPATH_BASE . '/templates/' . $app->getTemplate().'/html/com_fieldsattach/fields/contactrelated_line.tpl.php';
              ...
              $templateDir =  JPATH_BASE . '/templates/' . $app->getTemplate().'/html/com_fieldsattach/fields/'.$fieldsids.'_contactrelated_line.tpl.php';
