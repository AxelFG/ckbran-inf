...
Objteaserrelated = new Class({
	...
	initialize: function(id, options) {
		...
		this._bar = $(this.id); 
                ...
                $$("#fieldsattach-slider-teaserrelated .updatebutton").setStyle("display","none");
        ...
        revalue: function(){
            ...
            size = el.getElement("input#jform_params_field_teaserrelated_size").get("value"); 
        ...
        { 
            $('jform_params_field_teaserrelated_size').set("value", size); 
        },
        eventinput:function(obj){
            ...
            event.stop(); //Prevents the browser from following the teaserrelated.
            
            $("wrapperextrafield_teaserrelated").ObjInput.revalue();
            });
