...
class plgfieldsattachment_imagecarousel extends JPlugin
{
         protected $name;
         protected $path1;
	...
	function construct( )
	{
        ...
        function renderInput($articleid, $fieldsid, $value, $extras=null )
        {
            ...
            $str_gallery = '<div id="gallery_'.$fieldsid.'" class="galleryfield">'.plgfieldsattachment_imagecarousel::getGallery1($articleid, $fieldsid).'</div>';
                    $str =''; 
                    $str .= $str_gallery; 
        ...
        {
             $name = $this->name;
             $return ='<option value="imagecarousel" ';
             if("imagecarousel" == $valor)   $return .= 'selected="selected"';
             $return .= '>'.$name.'</option>';
             return $return ;
        }
        ...
        {
            //$str =   fieldattach::getimagecarousel($articleid, $fieldsid,$category);
            global $globalreturn;
            $html ="";
	    ...
	    $result = $db->loadObjectList();
            ...
            $published = plgfieldsattachment_imagecarousel::getPublished( $fieldsid  );

            if(!empty($result) && $published){
                $html = plgfieldsattachment_imagecarousel::getTemplate($fieldsid);
                $line = plgfieldsattachment_imagecarousel::getLineTemplate($fieldsid);
                $lines = "";
...
';
	 ...
	 */
        function getTemplate($fieldsids)
        {
             //Search field template GENERIC *****************************************************************
              $templateDir =  dirname(__FILE__).'/tmpl/imagecarousel.tpl.php'; 
              $html = file_get_contents ($templateDir);
              
              //Search field template in joomla Template  ******************************************************  
              $app = JFactory::getApplication();
              $templateDir =  JPATH_BASE . '/templates/' . $app->getTemplate().'/html/com_fieldsattach/fields/imagecarousel.tpl.php';
              ...
              $app = JFactory::getApplication();
              $templateDir =  JPATH_BASE . '/templates/' . $app->getTemplate().'/html/com_fieldsattach/fields/'.$fieldsids.'_imagecarousel.tpl.php';
	 ...
	 */
        ...
        {
             //Search field template GENERIC *****************************************************************
              $templateDir =  dirname(__FILE__).'/tmpl/imagecarousel_line.tpl.php'; 
              $html = file_get_contents ($templateDir);
              
              //Search field template in joomla Template  ******************************************************  
              $app = JFactory::getApplication();
              $templateDir =  JPATH_BASE . '/templates/' . $app->getTemplate().'/html/com_fieldsattach/fields/imagecarousel_line.tpl.php';
              ...
              //Search a specific field template in joomla Template  *********************************************  
              $app = JFactory::getApplication();
              $templateDir =  JPATH_BASE . '/templates/' . $app->getTemplate().'/html/com_fieldsattach/fields/'.$fieldsids.'_imagecarousel_line.tpl.php';
