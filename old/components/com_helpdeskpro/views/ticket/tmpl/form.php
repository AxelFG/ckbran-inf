...
print '<div><label for="captcha">' . JText::_('HDP_CAPTCHA_TEXT') . '</li><div><input class="inputbox ' . $mod_class_suffix . '" type="text" style="width:60px" maxlength="3" name="captcha" value="" />&nbsp;<img src="/libraries/captcha.png" width="120" height="30" border="1" alt="CAPTCHA" style="margin-bottom: 6px;" /></div></div>';					
?>
	<?php 
