		...
		<ul class="category list-striped">
			<?php foreach ($this->items as $i => $item) : ?>
				...
				<?php if (in_array($item->access, $this->user->getAuthorisedViewLevels())) : ?>
					...
					<div class="pull-left">
						<a href="<?php echo JRoute::_(ContactHelperRoute::getContactRoute($item->slug, $item->catid));; ?>" class="smallpic" rel="lightbox"><?php echo JHtml::_('image', $item->image, JText::_('COM_CONTACT_IMAGE_DETAILS'), array('align' => 'middle')); ?></a>
					</div>
							<?php endif; ?>
					<p>
