...
<?php if ($this->errors['captcha'] || $this->errors['name'] || $this->errors['body'])
...
<?php endif; ?>
	...
	<form id='addcommentform' action="<?php echo FSTRoute::x( '&tmpl=component&task=commentpost' );?>" method="post">
	...
	<?php if ($this->show_item_select && 0) : ?>
		<tr>
