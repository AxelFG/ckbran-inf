			...
			<?php foreach ($this->items as $i => $item) : ?>
				...
				<?php if (in_array($item->access, $this->user->getAuthorisedViewLevels())) : ?>
					...
					<?php endif; ?>
						...
						<a href="<?php echo JRoute::_(ContactHelperRoute::getContactRoute($item->slug, $item->catid)); ?>" class="thumb"><?php if (!empty($item->image) ) echo JHtml::_('image', $item->image, JText::_('COM_CONTACT_IMAGE_DETAILS'), array('align' => 'middle')); ?></a>
                    <?php list($lastname,$firstname,$middlename) = split(' ',$item->name); ?>
                    <h4>
							<a href="<?php echo JRoute::_(ContactHelperRoute::getContactRoute($item->slug, $item->catid)); ?>">
								<strong><?php echo $lastname; ?></strong><br /><?php echo $firstname; ?> <?php echo $middlename; ?></a>
                    </h4>
					<p>
