...
class JFormFieldMersubtmpls extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		$out = sprintf('<div class="row-fluid"><div class="span8">%s</div><div class="span4" id="%s_link"></div></div>%s', JHTML::_('select.genericlist', $options, $this->name . ($multi ? '[]' : NULL),  $multi . $javascript, 'value', 'text', $this->value, "{$this->id}"),
	...
	private function _getKey()
	{
		...
		$this->_key = md5("$option.$view." . time());
		return $this->_key;
	}
}