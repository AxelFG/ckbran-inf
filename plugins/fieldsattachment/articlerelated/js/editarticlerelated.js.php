...
Objeditarticlerelated = new Class({
	...
	initialize: function(id, options) {
        ...
        init: function(id){
            ...
            this._bar.Objeditarticlerelated = this;

              

            

            //this.initarticlerelated();
...

        {
            ...
            text = '<div style="position:relative;width:100%; padding:5px 0 5px 0;border-bottom:#ddd solid 1px;"><div style="  padding:5px 0 5px 0;">'+text+'</div>  <div style="position:absolute; top:10px; right:5px;"><a href="javascript:objarticlerelated_'+this.id+'.RemoveId('+id+')" class="btn"><i title="Удалить" class="icon-remove"></i>Удалить</a></a></div></div>';
