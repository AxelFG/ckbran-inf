...
function getBacklink($id, $type, $category = true)
{
	...
	if(!$category)
		$query = "SELECT articleid from #__fieldsattach_values WHERE (value LIKE '%,".$id.",%' OR value LIKE '".$id.",%' OR value LIKE '%,".$id."' OR value LIKE '".$id."') AND fieldsid = 18";

	else
		$query = "SELECT catid from #__fieldsattach_categories_values WHERE (value LIKE '%,".$id.",%' OR value LIKE '".$id.",%' OR value LIKE '%,".$id."' OR value LIKE '".$id."') AND fieldsid = 15";
