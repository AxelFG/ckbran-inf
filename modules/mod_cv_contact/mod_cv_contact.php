...
$app->initialise();
  ...
  if ($_POST["rp_email"] === "") {
    ...
    $myError = '<span class="error" style="color: ' . $error_text_color . ';">Пожалуйста, введите Ваши контактные данные</span>';

  }
  if ($_POST["rp_subject"] === "") {

    $myError = '<span class="error" style="color: ' . $error_text_color . ';">Пожалуйста, введите Ваше имя</span>';

  }
  if ($_POST["rp_spec"] === "") {

    $myError = '<span class="error" style="color: ' . $error_text_color . ';">Пожалуйста, введите Вашу специализацию</span>';
...
//  }
  ...
  if ($myError == '') {
    ...
    if ($mailSender->Send() !== true) {
      ...
      $myReplacement = '<div class="contact"><span class="thanks" style="color: '.$thanksTextColor.';">' . $pageText . '</span></div>';
